...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-chatbot.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-chatbot)
...
```bash
php artisan vendor:publish --tag="laravel-chatbot-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-chatbot-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-chatbot-views"
```
